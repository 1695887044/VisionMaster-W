...
namespace VisionMaster.Communications
{
    ...
    /// <para>基于 HslCommunication 库实现串口 Modbus RTU 协议的通信功能。</para>
    /// <para>支持标准 Modbus RTU 协议的读写操作。</para>
    /// </summary>
    /// <example>
    /// <code>
    /// // 使用 CommunicationConfig 创建
    /// var config = CommunicationConfig.CreateModbusRtu("COM1", 9600);
    ...
    public class SerialConnection : BaseConnection<ModbusRtu>
    {
        ...
        /// <summary>
        /// <para>使用 CommunicationConfig 创建串口连接。</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>使用 SerialConfig 创建串口连接。</para>
        /// </summary>
        /// <param name="config">串口配置对象</param>
        ...
        /// <summary>
        /// <para>初始化串口设备对象。</para>
        /// <para>创建 ModbusRtu 实例并配置串口参数。</para>
        /// </summary>
        ...
        /// </summary>
        /// <returns>包含串口名称和波特率的字符串</returns>
