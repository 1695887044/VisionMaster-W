...
namespace HslCommunication.Language
{
	...
	public class English : DefaultLanguage
	{
		...
		public override string TooManyLock => $"Too many read and write operations have occurred, resulting in a large accumulation of locks ({HslHelper.LockLimit}), so this read and write fails, please try again later.";
