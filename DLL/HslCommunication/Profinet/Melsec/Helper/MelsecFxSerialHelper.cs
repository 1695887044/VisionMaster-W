...
namespace HslCommunication.Profinet.Melsec.Helper
{
	...
	public class MelsecFxSerialHelper
	{
		...
		private static OperateResult<ushort, ushort, ushort> FxCalculateBoolStartAddress(string address, bool isNewVersion)
		{
			...
			if (operateResult.Content1 == MelsecMcDataType.M)
			{
				content = (isNewVersion ? ((content < 8000) ? ((ushort)((int)content / 8 + 34816)) : ((ushort)((content - 8000) / 8 + 35840))) : ((content < 8000) ? ((ushort)((int)content / 8 + 256)) : ((ushort)((content - 8000) / 8 + 480))));
			}
			else if (operateResult.Content1 == MelsecMcDataType.X)
			{
				content = (ushort)((int)content / 8 + (isNewVersion ? 36000 : 128));
			}
			else if (operateResult.Content1 == MelsecMcDataType.Y)
			{
				content = (ushort)((int)content / 8 + (isNewVersion ? 35776 : 160));
			}
			else if (operateResult.Content1 == MelsecMcDataType.S)
			{
				content = (ushort)((int)content / 8 + (isNewVersion ? 36064 : 0));
			}
			else if (operateResult.Content1 == MelsecMcDataType.CS)
			{
				content = (ushort)((int)content / 8 + (isNewVersion ? 37696 : 448));
			}
			else if (operateResult.Content1 == MelsecMcDataType.CC)
			{
				content = (ushort)((int)content / 8 + (isNewVersion ? 37600 : 960));
			}
			else if (operateResult.Content1 == MelsecMcDataType.TS)
			{
				content = (ushort)((int)content / 8 + (isNewVersion ? 37728 : 192));
			}
			else
			{
				...
				content = (ushort)((int)content / 8 + (isNewVersion ? 37632 : 704));
			}
