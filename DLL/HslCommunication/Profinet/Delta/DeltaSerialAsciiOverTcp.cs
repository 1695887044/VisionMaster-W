...
namespace HslCommunication.Profinet.Delta
{
	...
	public class DeltaSerialAsciiOverTcp : ModbusAsciiOverTcp, IDelta, IReadWriteDevice, IReadWriteNet
	{
		...
		/// <inheritdoc cref="M:HslCommunication.Profinet.Delta.DeltaSerialAsciiOverTcp.ReadBool(System.String,System.UInt16)" />
		public override async Task<OperateResult<bool[]>> ReadBoolAsync(string address, ushort length)
		{
			return await DeltaHelper.ReadBoolAsync(this, (string address, ushort length) => base.ReadBoolAsync(address, length), address, length);
		}

		/// <inheritdoc cref="M:HslCommunication.Profinet.Delta.DeltaSerialAsciiOverTcp.Write(System.String,System.Boolean[])" />
		public override async Task<OperateResult> WriteAsync(string address, bool[] values)
		{
			return await DeltaHelper.WriteAsync(this, (string address, bool[] values) => base.WriteAsync(address, values), address, values);
		}

		/// <inheritdoc cref="M:HslCommunication.Profinet.Delta.DeltaSerialAsciiOverTcp.Read(System.String,System.UInt16)" />
		public override async Task<OperateResult<byte[]>> ReadAsync(string address, ushort length)
		{
			return await DeltaHelper.ReadAsync(this, (string address, ushort length) => base.ReadAsync(address, length), address, length);
		}

		/// <inheritdoc cref="M:HslCommunication.Profinet.Delta.DeltaSerialAsciiOverTcp.Write(System.String,System.Byte[])" />
		public override async Task<OperateResult> WriteAsync(string address, byte[] value)
		{
			return await DeltaHelper.WriteAsync(this, (string address, byte[] value) => base.WriteAsync(address, value), address, value);
		}
