...
namespace HslCommunication.Profinet.XINJE
{
	...
	public class XinJETcpNet : ModbusTcpNet
	{
		...
		{
			return await XinJEHelper.ReadAsync(this, address, length, (string address, ushort length) => base.ReadAsync(address, length));
		}

		/// <inheritdoc />
		public override async Task<OperateResult> WriteAsync(string address, byte[] value)
		{
			return await XinJEHelper.WriteAsync(this, address, value, (string address, byte[] value) => base.WriteAsync(address, value));
		}

		/// <inheritdoc />
		public override async Task<OperateResult> WriteAsync(string address, short value)
		{
			return await XinJEHelper.WriteAsync(this, address, value, (string address, short value) => base.WriteAsync(address, value));
		}

		/// <inheritdoc />
		public override async Task<OperateResult> WriteAsync(string address, ushort value)
		{
			return await XinJEHelper.WriteAsync(this, address, value, (string address, ushort value) => base.WriteAsync(address, value));
		}

		/// <inheritdoc />
		public override async Task<OperateResult<bool[]>> ReadBoolAsync(string address, ushort length)
		{
			return await XinJEHelper.ReadBoolAsync(this, address, length, (string address, ushort length) => base.ReadBoolAsync(address, length));
		}

		/// <inheritdoc />
		public override async Task<OperateResult> WriteAsync(string address, bool[] values)
		{
			return await XinJEHelper.WriteAsync(this, address, values, (string address, bool[] values) => base.WriteAsync(address, values));
		}

		/// <inheritdoc />
		public override async Task<OperateResult> WriteAsync(string address, bool value)
		{
			return await XinJEHelper.WriteAsync(this, address, value, (string address, bool value) => base.WriteAsync(address, value));
		}
