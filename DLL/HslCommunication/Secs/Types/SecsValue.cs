	...
	public class SecsValue
	{
		...
		public XElement ToXElement()
		{
			if (ItemType == SecsItemType.List)
			{
				...
				IEnumerable<SecsValue> enumerable = Value as IEnumerable<SecsValue>;
				if (enumerable != null)
				{
		...
		public byte[] ToSourceBytes(Encoding encoding)
		{
			...
			if (ItemType == SecsItemType.List)
			{
				...
				SecsValue[] array = Value as SecsValue[];
				if (array != null)
				{
					SecsValue[] array2 = array;
					foreach (SecsValue secsValue in array2)
					{
		...
		private static string getSourceCode(SecsValue secsValue)
		{
			...
			{
				Array array = secsValue.Value as Array;
				if (array != null)
				{
			...
			{
				Array array2 = secsValue.Value as Array;
				if (array2 != null)
				{
			...
			{
				Array array3 = secsValue.Value as Array;
				if (array3 != null)
				{
			...
			{
				Array array4 = secsValue.Value as Array;
				if (array4 != null)
				{
			...
			{
				Array array5 = secsValue.Value as Array;
				if (array5 != null)
				{
			...
			{
				Array array6 = secsValue.Value as Array;
				if (array6 != null)
				{
			...
			{
				Array array7 = secsValue.Value as Array;
				if (array7 != null)
				{
			...
			{
				Array array8 = secsValue.Value as Array;
				if (array8 != null)
				{
			...
			{
				Array array9 = secsValue.Value as Array;
				if (array9 != null)
				{
			...
			{
				Array array10 = secsValue.Value as Array;
				if (array10 != null)
				{
			...
			{
				Array array11 = secsValue.Value as Array;
				if (array11 != null)
				{
			...
			Array array12 = secsValue.Value as Array;
			if (array12 != null)
			{
				return "Unkonw data";
			}
		...
		public static int GetValueLength(SecsValue secsValue)
		{
			...
			if (secsValue.ItemType == SecsItemType.List)
			{
				return (secsValue.Value as IEnumerable<SecsValue>)?.Count() ?? 0;
			}
